...
public class Stockout extends AppCompatActivity implements View.OnClickListener{
    ...
    static StockIn.Stack stack=new StockIn.Stack();
    ...
    static class Node{
        ...
        public StockIn.Node getNext() {
            return next;
        }

        public void setNext(StockIn.Node next) {
            this.next = next;
        }
        ...
        public boolean equals(Object o) {
            ...
            StockIn.Node node = (StockIn.Node) o;
    ...
    static  class Stack{
        ...
        public void  push(String product){
            ...
            StockIn.Node top=new StockIn.Node(product);
            top.setNext(node);
